...
public class PessoaPerfilD implements Serializable {
    private String CPF;
    private String nome;
    ...
    private static TypeDesc typeDesc = new TypeDesc(PessoaPerfilD.class, true);

    static {
        typeDesc.setXmlType(new QName("https://infoconv.receita.fazenda.gov.br/ws/cpf/", "PessoaPerfilD"));
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PessoaPerfilD)) {
            return false;
        } else {
            PessoaPerfilD other = (PessoaPerfilD)obj;
            if (obj == null) {
                return false;
            } else if (this == obj) {
                return true;
