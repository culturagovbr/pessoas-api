...
public class EstabelecimentoHadoopDTODeserializer implements JsonDeserializer<EstabelecimentoHadoop> {

	public EstabelecimentoHadoop deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext)
		...
		if (jsonElement.isJsonObject() || !jsonElement.getAsString().equalsIgnoreCase("Not")) {
			...
			return new EstabelecimentoHadoop(cnpj, colunas);
