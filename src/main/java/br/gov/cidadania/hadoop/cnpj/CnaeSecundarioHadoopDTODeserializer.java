...
public class CnaeSecundarioHadoopDTODeserializer implements JsonDeserializer<CnaeSecundarioHadoop> {

	public CnaeSecundarioHadoop deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext)
		...
		if (jsonElement.isJsonObject() || !jsonElement.getAsString().equalsIgnoreCase("Not")) {
			...
			return new CnaeSecundarioHadoop(cnpj, colunas);
